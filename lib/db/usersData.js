...
import { ALL_ROLES, TEAMS } from '@/lib/constants';
 ...
 *   getUsers(teamId)        — acquires its own DB connection (for RSC pages)
 *   getUsers(db, teamId)   — uses the provided DB connection (for route handlers)
 */
