...
"affectedCases": [ { "id": "<_id>", "reason": string, "update": { only fields that must change: "testCase"?, "preconditions"?, "steps"? (HTML <ol><li>…</li></ol>), "expectedResult"?, "priority"? } } ]
"newCases": [ { "testCase", "preconditions", "steps" (HTML), "expectedResult", "priority": "High"|"Medium"|"Low", "type": "Functional Test"|"Edge Case"|"Negative Test"|"Security Test" } ]
"obsoleteCases": [ { "id": "<_id>", "reason": string } ]
