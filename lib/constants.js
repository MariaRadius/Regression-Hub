...
/**
 * Sentinel value stored on an assignment's `environment` field to indicate
 * a release-wide (all-environment) assignment.
 */
export const ENVIRONMENT_SENTINEL = '__all__';
