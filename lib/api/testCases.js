 ...
 */
export function updateTestCaseContent(releaseId, tcId, fields, options = {}) {
  return patch(
    `/api/releases/${releaseId}/test-cases/${tcId}`,
    fields,
    options,
  );
}
 ...
 * @param {string} tcId
 */
export function deleteTestCaseById(releaseId, tcId, options = {}) {
 ...
 */
export function createTestCaseInRelease(releaseId, body, options = {}) {
  return post(`/api/releases/${releaseId}/test-cases`, body, options);
}
