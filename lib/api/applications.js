...
/**
 * Update an application's test case ID prefix.
 *
 * @param {string} id
 * @param {{ initial: string }} body
 * @returns {Promise<{ ok: true }>}
 */
export function updateApplication(id, body, opts = {}) {
  return patch(`/api/applications/${id}`, body, {
    schema: z.object({ ok: z.literal(true), renamedCount: z.number() }),
    ...opts,
  });
}
