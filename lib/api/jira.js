 ...
 * Returns { valid: boolean } — silently returns { valid: false } on network error.
 *
 * @param {string} key - e.g. "AIOP-123"
 */
export function validateJiraStory(key) {
  return get(`/api/jira/validate-story?key=${encodeURIComponent(key)}`, {
