...
export const recordResultBodySchema = z.object({
  ...
  // Jira key linking a Known Issue to its tracked ticket. Required + format
  // enforced in the data layer (recordResult) when status is Known Issue.
...
export const resultSummarySchema = z.object({
  ...
  knownIssue: z.number().int().nonnegative(),
