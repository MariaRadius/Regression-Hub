 ...
 *
 * @param {object} args
 * @param {{ testKey?: string, testCase: string, jiraStory?: string|null, steps?: string, expectedResult?: string }} args.testCase
 ...
 * @see {@link lib/__tests__/jiraIssue.test.js}
 */
export function buildJiraIssueDraft({ testCase, notes, applicationName }) {
  ...
  return {
    ...
    jiraStory: testCase.jiraStory ?? null,
  };
}
 ...
 * the `test-atlas` label are supplied by the server, never the client.
 *
